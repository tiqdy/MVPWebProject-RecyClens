...
st.set_page_config(
    page_title="Cardboard - RecycLens",
    page_icon="📦",
    layout="wide",
...
<div class="main-page-title">CARDBOARD</div>
...
# Image Loading 
img1 = get_img_base64("images/cardboardpage/card1.jpeg") 
img2 = get_img_base64("images/cardboardpage/card2.jpg") 
img3 = get_img_base64("images/cardboardpage/card3.jpg") 
img4 = get_img_base64("images/cardboardpage/card4.jpg") 

# HERO SECTION
st.markdown(f"""
<div class="hero-container">
<div class="hero-subtitle">Recyclable Packaging with a Second Life</div>
...
Cardboard is a paper-based material commonly used for packaging and shipping. 
It is highly recyclable and can be reused multiple times when disposed of correctly.
</div>
</div>
""", unsafe_allow_html=True)
...
<div class="box-title">⚠️ Why Cardboard Waste Matters</div>
<div class="box-text">
Cardboard waste takes up a large portion of household and commercial trash. 
When recyclable cardboard is thrown away improperly, it leads to:
<ul>
<li>Increased landfill volume</li>
<li>Unnecessary tree cutting</li>
<li>Higher energy use in producing new materials</li>
</ul>
</div>
</div>
""", unsafe_allow_html=True)
...
<div class="box-title">♻️ How to Dispose of Cardboard Correctly</div>
<div class="box-text">
<strong>✅ Do:</strong>
<ul>
<li>Flatten boxes before recycling</li>
<li>Keep cardboard clean and dry</li>
<li>Remove plastic tape or labels if possible</li>
</ul>
<strong>❌ Don’t:</strong>
<ul>
<li>Recycle greasy or food-contaminated cardboard</li>
<li>Mix wet or soaked cardboard with recyclables</li>
<li>Include wax-coated or plastic-lined cardboard</li>
</ul>
</div>
</div>
    """, unsafe_allow_html=True)
...
with col_right:
    ...
    st.markdown("""
<div class="content-box box-green">
<div class="box-title">🌱 Environmental Benefits of Recycling Cardboard</div>
<div class="box-text">
<ul>
<li>Saves trees and natural resources</li>
<li>Uses less water and energy than new production</li>
